...
@ContextConfiguration(initializers = [R2dbcDataWithPrototypeContainerIntegrationTest.Companion.Initializer::class])
class R2dbcDataWithPrototypeContainerIntegrationTest {
    ...
    companion object {
        ...
        private val LOGGER: Logger = getLogger(R2dbcDataWithPrototypeContainerIntegrationTest::class.java)
